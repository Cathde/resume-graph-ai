...
export const metadata: Metadata = {
  title: "Resume Graph AI｜简历版本与岗位定制分析",
  description: "在浏览器本地管理简历版本与岗位 JD，并使用自己的 AI API 分析每次定制修改。",
  icons: {
    icon: "/favicon.svg",
...
async function SocialMeta({ originPromise }: { originPromise: Promise<string | null> }) {
  ...
  return <>
    ...
    <meta property="og:description" content="在浏览器本地管理简历谱系，并用自己的 AI API 分析岗位定制修改。" />
